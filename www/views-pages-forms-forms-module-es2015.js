...
/* harmony import */ var _forms_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./forms.page */ "./src/app/views/pages/forms/forms.page.ts");
...
let FormsPage = class FormsPage {
    constructor() {
        this.data = [
            { grupo: [{ title: 'Partidos', icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faCalendarAlt"], route: './category/partidos' }, { title: 'Equipo', icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faUsers"], route: './category/equipo' }] },
            { grupo: [{ title: 'Servicios', icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faTicketAlt"], route: './category/servicios' }, { title: 'Directiva', icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faUserTie"], route: './category/directiva' }] },
            { grupo: [{ title: 'Estadio', icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faFutbol"], route: './category/estadio' }, { title: 'Información', icon: _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faInfoCircle"], route: './category/información' }] }
        ];
    }
    ngOnInit() {
    }
...
FormsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-forms',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./forms.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/views/pages/forms/forms.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./forms.page.scss */ "./src/app/views/pages/forms/forms.page.scss")).default]
    }),
...
//# sourceMappingURL=views-pages-forms-forms-module-es2015.js.map