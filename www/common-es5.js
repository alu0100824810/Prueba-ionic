  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function srcAppCoreServicesFirebaseAppServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var FirebaseAppService = /*#__PURE__*/function () {
        function FirebaseAppService(firestore) {
        ...
        _createClass(FirebaseAppService, [{
                ...
                return regeneratorRuntime.wrap(function _callee6$(_context6) {
                  while (1) {
                    switch (_context6.prev = _context6.next) {
                      case 0:
                        try {
                          result = this.firestore.collection('concursos-sorteos').doc("".concat(date)).collection('sorteos').doc("".concat(id)).snapshotChanges();
                          resolve(result);
                        } catch (error) {
                          console.error(error);
                          reject(error);
          ...
          value: function takePartOnlyDraw(date, id, user) {
            var _this5 = this;
      ...
      FirebaseAppService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]])], FirebaseAppService);
      /***/
    }
  }]);
})();
