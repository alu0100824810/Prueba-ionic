...
/* harmony import */ var _login_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./login.page */ "./src/app/views/login/login.page.ts");
...
let LoginPage = class LoginPage {
    ...
    login(event) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            let { user } = this;
            try {
                yield this.messages.showSpinner('Iniciando sesión...');
                yield this.loginService.logIn(user.email, user.password);
